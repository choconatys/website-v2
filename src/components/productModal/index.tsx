...
import { ModalButtonsWrapper, ModalCloseButton, ModalContent, ModalDescription, ModalInfo, ModalPhoto, ModalWrapper } from "./styles";
                ...
                <ModalWrapper>
                    ...
                    >
                        ...
                        <section className="photoWrapper">
                            <ModalPhoto src={`http://localhost:3030/${product.photo}`} alt="Photo" />
                        </section>
                        ...
                        <ModalButtonsWrapper>
                            ...
                            >
                                ...
                                <span className="leftSpacing">
                                    {quantity === 0 ? product.priceFormated : balance(quantity * product.price)}
                                </span>
                            </Button>
                        </ModalButtonsWrapper>
                    </ModalContent>
